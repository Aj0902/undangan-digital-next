      ...
      */}
      <div
        className={
          isOpen
            ? "opacity-100"
            : "opacity-0 h-screen overflow-hidden transition-opacity duration-1000"
        }
      >
        {/* ... (rest of components) */}
        ...
        <footer className="py-24 text-center bg-cream relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-6">
            <p className="font-body text-[10px] uppercase tracking-[0.6em] text-gold/60">
              Arigato Gozaimasu
            </p>
            <h2 className="font-heading text-4xl text-primary font-light mb-4">
              {data.client_details.bride_name}{" "}
              <span className="text-gold italic">&amp;</span>{" "}
              {data.client_details.groom_name}
            </h2>
