    ...
    <section className="w-full py-24 px-8 bg-transparent text-center flex flex-col items-center">
      ...
      <FadeIn className="w-full max-w-sm">
        ...
        <div className="pt-8 pb-10 border-t border-neutral-300 w-full relative">
           ...
           <button onClick={() => handleCopy("8765432109", "Nomor Rekening")} className="px-8 py-4 border border-black bg-black text-white text-[0.65rem] uppercase tracking-[0.25em] hover:bg-neutral-800 transition-all duration-700 w-full hover:tracking-[0.4em]">
             Salin Rekening
           </button>
        </div>
        ...
        <div className="pt-8 pb-10 border-t border-neutral-300 w-full relative">
           ...
           <button onClick={() => handleCopy("1098765432", "Nomor Rekening")} className="px-8 py-4 border border-black bg-black text-white text-[0.65rem] uppercase tracking-[0.25em] hover:bg-neutral-800 transition-all duration-700 w-full hover:tracking-[0.4em]">
             Salin Rekening
           </button>
        </div>
