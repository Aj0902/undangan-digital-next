        ...
        <div className="md:col-span-5 flex flex-col justify-center">
           ...
           >
              <h2 className="font-heading text-4xl md:text-5xl text-stone-900 tracking-tighter leading-tight mb-4 lowercase">
                 <span className="text-stone-400 italic font-light">The Wedding</span> <br/>
                 Exhibition
              </h2>
              <div className="w-8 h-px bg-rose-600 mb-4" />
              <p className="font-mono text-[8px] uppercase tracking-[0.2em] text-stone-500">Medium: Love & Time</p>
           </motion.div>
           ...
           >
              ...
              <p className="text-[10px] uppercase tracking-[0.2em] text-stone-900 mt-6 font-bold font-mono">Ar-Rum 21</p>
           </motion.div>
        </div>
           ...
           >
              <div className="w-full h-full overflow-hidden bg-stone-300">
                 {portraitUrl ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center font-mono text-[10px] uppercase tracking-widest text-stone-400">Artwork Placeholder</div>
                 )}
              </div>
           </motion.div>
        </div>
