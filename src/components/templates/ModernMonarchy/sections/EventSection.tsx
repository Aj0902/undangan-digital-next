...
const EventBlock = ({ title, date, venue, address, id }: EventBlockProps) => {
  if (!date && !venue) return null;

  return (
    <div className="w-full flex justify-between border-b border-stone-800 py-12 md:py-16">
      <div className="w-1/3 md:w-1/4">
        <p className="font-mono text-[8px] uppercase tracking-[0.4em] text-stone-600 mb-8 md:mb-16">
          Event.ID.{id}
        </p>
        <h3 className="font-heading text-3xl md:text-5xl text-[#E5E4E2] leading-none tracking-tighter lowercase">
          {title}
        </h3>
      </div>
      <div className="w-2/3 md:w-3/4 flex flex-col md:flex-row justify-end text-right md:text-left md:items-end gap-8 md:gap-24">
        <div className="text-right">
          <p className="font-mono text-[8px] uppercase tracking-[0.4em] text-stone-600 mb-2">
            Timestamp
          </p>
          <p className="font-mono text-sm md:text-xl text-[#E5E4E2] font-light tracking-[0.2em]">
            {formatDate(date)}
          </p>
          <p className="font-mono text-xs md:text-lg text-stone-500">
            {formatTime(date)} Hrs
          </p>
        </div>
        <div className="text-right">
          ...
          <p className="font-body text-sm md:text-xl text-[#E5E4E2] uppercase font-bold tracking-widest">
            {venue}
          </p>
          <p className="font-mono text-[8px] md:text-[10px] uppercase tracking-[0.2em] text-stone-500 md:max-w-[200px] mt-2">
            {address}
          </p>
          <a
  ...
  return (
    <section className="relative w-full py-40 px-8 md:px-16 bg-[#0A0A0A] overflow-hidden border-b border-[#E5E4E2]/10">
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          <h2 className="font-mono text-[10px] md:text-xs uppercase tracking-[0.5em] text-[#E5E4E2] font-bold">
            The State Affair
          </h2>
