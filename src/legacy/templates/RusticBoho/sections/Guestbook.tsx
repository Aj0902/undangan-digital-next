    ...
    <section className="relative w-full py-32 px-8 md:px-16 bg-[#FDFBF7] overflow-hidden border-b border-stone-100">
      <div className="max-w-4xl mx-auto flex flex-col md:grid md:grid-cols-2 gap-16 md:gap-24">
        ...
        <motion.div
          ...
          className="bg-white p-8 md:p-12 rounded-[40px] md:rounded-[50px] shadow-2xl relative border border-stone-50"
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest opacity-50 ml-4">
                Nama Lengkap
              </label>
              <input
                type="text"
                ...
                greetings.map((msg, i) => (
                  ...
                  >
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <span
                        className={`text-[8px] uppercase tracking-widest font-bold px-3 py-2 rounded-full border ${msg.attendance_status ? "bg-[#D4A373]/10 text-[#D4A373] border-[#D4A373]/20" : "bg-stone-50 text-stone-400 border-stone-100"}`}
                      >
