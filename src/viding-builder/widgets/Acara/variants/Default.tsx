...
export default function AcaraDefault({ clientData, accentColor = "#D4AF37" }: AcaraDefaultProps) {
  ...
  const EventCard = ({ title, datetime, venueName, venueAddress, color }: {
    title: string; datetime: string | null; venueName: string | null; venueAddress: string | null; color: string;
  }) => (
    <motion.div
    ...
    >
      ...
      {(venueName || venueAddress) && (
        <button
          onClick={() => openMaps(venueName, venueAddress)}
